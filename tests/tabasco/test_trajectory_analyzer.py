...
class TestMetrics:
    def test_attention_entropy_uniform(self):
        ...
        from playground.tabasco.mech_interp.metrics import attention_entropy
    ...
    def test_bond_precision_perfect(self):
        ...
        from playground.tabasco.mech_interp.metrics import bond_precision
    ...
    def test_structure_lens_rmsd_identical(self):
        ...
        from playground.tabasco.mech_interp.metrics import structure_lens_rmsd
    ...
    def test_atom_accuracy_perfect(self):
        ...
        from playground.tabasco.mech_interp.metrics import atom_type_accuracy
...
class TestAblationConfig:
    def test_should_ablate_in_range(self):
        from playground.tabasco.mech_interp.trajectory_analyzer import AblationConfig
