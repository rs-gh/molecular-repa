...
Outputs:
  - figures/paper/n256_convergence/gen_vs_rep_correlation.png  (3 rep x 2 gen
    scatter grid per dataset; panel titles show Spearman rho).
  - results/paper/n256_convergence_gen_vs_rep_correlation.{csv,md} with
...
FIG_BASE = (
    REPO_ROOT / "evaluation/proteina/joint/figures/paper/n256_convergence/correlation"
)
...
# - xclean     : doubly-clean cross-DB val (cleanest Δ).
# Datasets missing from a variant are skipped for that variant.
...
RUN_FAMILIES = {
    "PDB": [
        ("baseline_256_bs24_2gpu", "Baseline", "tab:blue"),
        ("repa_l4_256_per_residue_bs24_2gpu", "REPA L4 GearNet", "tab:red"),
        ("repa_l9_256_per_residue_bs24_2gpu", "REPA L9 GearNet", "tab:orange"),
        ("repa_mpnn_l4_256_per_residue", "REPA L4 MPNN", "tab:green"),
        ("repa_mpnn_l9_256_per_residue", "REPA L9 MPNN", "tab:purple"),
    ],
    "AFDB": [
        ("baseline_afdb_256", "Baseline", "tab:blue"),
        ("repa_l4_afdb_256", "REPA L4 GearNet", "tab:red"),
        ("repa_l9_afdb_256", "REPA L9 GearNet", "tab:orange"),
...
def main() -> None:
    ...
    for variant, datasets in VARIANTS.items():
        all_corr.extend(_run_variant(variant, datasets, "n=256"))

    corr_df = pd.DataFrame(all_corr)
    csv_path = TAB_OUT / "n256_convergence_gen_vs_rep_correlation.csv"
    md_path = TAB_OUT / "n256_convergence_gen_vs_rep_correlation.md"
    # Reorder columns so variant is first for readability.
