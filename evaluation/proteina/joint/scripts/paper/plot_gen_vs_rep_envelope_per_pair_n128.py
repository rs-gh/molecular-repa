...
# One per_pair envelope set per variant. n=128 has no xclean_pdb_afdb dir,
# so the xclean variant ships PDB only.
VARIANTS: Dict[str, Dict[str, dict]] = {
    "cath_if_dih": {
        "PDB": _pdb("n128_convergence_cath_if_dih_pdb"),
        "AFDB": _afdb("n128_convergence_cath_if_dih_afdb"),
    },
    "cleantrain": {
        "PDB": _pdb("n128_convergence_cleantrain_pdb"),
    },
    "xclean": {
        "PDB": _pdb("n128_xclean_afdb_pdb"),
    },
}
...
def plot_metric(
    ...
    suptitle = (
        f"n=128 (rep={variant}) — generation vs representation envelope per baseline–REPA pair\n"
