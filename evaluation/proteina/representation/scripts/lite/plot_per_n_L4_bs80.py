...
Reads results/lite/n128_L4_bs80_lite/sweep_results.csv and produces a 2 x 3 grid:
...
Usage:
    python evaluation/proteina/representation/scripts/lite/plot_per_n_L4_bs80.py
"""
...
RESULTS = REPR_ROOT / "results" / "lite" / "n128_L4_bs80_lite"
FIG_DIR = REPR_ROOT / "figures" / "lite" / "n128_L4_bs80_lite"
...
if __name__ == "__main__":
    df = _load()
    _plot_grid(df, "p_at_L_5_linear", "P@L/5 (linear)", "contact/per_layer_PaL5.png")
    _plot_grid(df, "cath_acc", "CATH accuracy", "cath/per_layer_cath.png")
