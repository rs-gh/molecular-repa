...
``evaluation/proteina/representation/figures/paper/contact_max256/contact/``.
...
Usage
-----
  python evaluation/proteina/representation/scripts/paper/plot_contact_probe.py
"""
...
CSV = (
    REPR_ROOT / "results" / "paper" / "contact_max256" / "pretrained_sweep_results.csv"
)
FIG_DIR = REPR_ROOT / "figures" / "paper" / "contact_max256" / "contact"
