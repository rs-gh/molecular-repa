...
def run_trajectory_analysis(args):
    ...
    from playground.tabasco.mech_interp.trajectory_analyzer import TrajectoryAnalyzer
    from playground.tabasco.mech_interp.visualization import plot_all
...
def run_ablation_experiments(args):
    ...
    from playground.tabasco.mech_interp.trajectory_analyzer import (
        TrajectoryAnalyzer,
        get_standard_ablation_configs,
    )
    from playground.tabasco.mech_interp.visualization import plot_ablation_summary
    from tabasco.chem.convert import MoleculeConverter
...
def main():
    ...
    parser.add_argument(
        "--output-dir", type=str, default="playground/tabasco/mech_interp/results"
    )
