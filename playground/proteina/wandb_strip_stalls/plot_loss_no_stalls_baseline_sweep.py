"""Stall-stripped trans-loss plot for the baseline 128 sweep (bs24/bs80/bs80_lr3x)."""
...
RUNS: dict[str, tuple[str, str]] = {
    "0427-1929-proteina_60m_baseline_128_bs80_lr3x": ("tab:gray", "-"),
    "0427-1826-proteina_60m_baseline_128_bs80": ("tab:purple", "-"),
    "0418-1137-proteina_60m_baseline_128_bs_24": ("tab:cyan", "-"),
}
...
def main() -> None:
    ...
    p.add_argument(
        "--out",
        type=Path,
        default=Path(__file__).parent / "loss_no_stalls_baseline_sweep.png",
    )
    p.add_argument(
        "--cache",
        type=Path,
        default=Path(__file__).parent / "history_cache_baseline_sweep.pkl",
    )
