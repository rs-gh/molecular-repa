...
FCD\,$\downarrow$~\cite{FCD} & Fr\'echet ChemNet Distance: Fr\'echet distance over the whole set in a property-prediction network's feature space & Distribution mismatch & Distance \\
\bottomrule
\end{tabular}
