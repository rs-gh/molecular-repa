...
OUT = f"{ROOT}/docs/masters-report/tables/table_speedup_data.tex"
CAP = 2_000_000
EARLY = 400_000
...
lines = [
    "% Numbers generated by tables/scripts/make_speedup_table.py --- safe to overwrite.",
    "% The caption and table environment are hand-maintained in table_speedup.tex.",
    "\\begin{tabular}{l c c}",
    "\\toprule",
