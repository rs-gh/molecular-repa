...
def main():
    ...
    parser.add_argument(
        "--all",
        action="store_true",
        help="Strip all known GEOM checkpoints to ./evaluation_checkpoints/",
    )
    args = parser.parse_args()

    if args.all:
        out_dir = Path("evaluation_checkpoints")
