...
#! Run qm9/chemprop experiment on 2 GPUs with DDP (REPA with ChemProp encoder)
#!
...
#! 15 workers per GPU process (CPUS / num_gpus - 1)
num_workers=$((SLURM_CPUS_PER_TASK / 2 - 1))
