...
#! Run geom/mace_cached_additive experiment (REPA with cached MACE encoder, additive)
...
#! Name of the job:
#SBATCH -J geom-mace-cached-additive
...
experiment="geom/mace_cached_additive"
...
SEED_CKPT="$OUTPUTS_DIR/geom_mace_additive_v2/checkpoints/last.ckpt"
