#!/bin/bash
#!
#! SLURM job script for Proteina REPA training on AFDB Swiss-Prot.
#! Mirrors hpc-scripts/proteina/training/pdb/train_repa.sh but stages the
#! AFDB LMDB from Lustre to local NVMe.
#!
#! Config tree: training/256/afdb/<encoder>/[<averaging>/]<config_name>.yaml
#!
#! Usage:
#!   sbatch .../train_repa.sh training_repa_l4_256_afdb_per_residue training/256/afdb/gearnet/per_residue
#!   sbatch .../train_repa.sh training_repa_l0_256_afdb_per_residue training/256/afdb/gearnet/per_residue
#!   sbatch .../train_repa.sh training_repa_l9_256_afdb_per_residue training/256/afdb/gearnet/per_residue
#!   sbatch .../train_repa.sh training_repa_l4_256_afdb_per_sample   training/256/afdb/gearnet/per_sample
#!   sbatch .../train_repa.sh training_repa_esm_l9_256_afdb_per_residue training/256/afdb/esm2/per_residue
#!   sbatch .../train_repa.sh training_repa_l0_256_afdb_per_residue_mc_edge training/256/afdb/gearnet_rep/per_residue
#!
...
#SBATCH --output=/rds/user/sr2173/hpc-work/proteina/logs/afdb-repa-%j.out
#SBATCH --error=/rds/user/sr2173/hpc-work/proteina/logs/afdb-repa-%j.err
...
GPU_LOG="/rds/user/sr2173/hpc-work/proteina/logs/gpu-util-afdb-repa-${SLURM_JOB_ID}.csv"
