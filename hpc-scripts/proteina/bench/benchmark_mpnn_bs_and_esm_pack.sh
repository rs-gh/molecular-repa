#!/bin/bash
#! Test MPNN --batch_size=8 and ESMFold 1x8 packing. With TF32 already in.

#SBATCH -J mpnn-esm-pack
...
#SBATCH --output=/rds/user/sr2173/hpc-work/proteina/logs/mpnn-esm-pack-%j.out
#SBATCH --error=/rds/user/sr2173/hpc-work/proteina/logs/mpnn-esm-pack-%j.err
#SBATCH -p ampere
...
python -u hpc-scripts/proteina/bench/benchmark_mpnn_bs_and_esm_pack.py \
    --samples_dir "$SAMPLES_DIR" \
    --L 200 \
    --n_pdbs 5 \
    --tmp_root "$TMPDIR/mpnn_esm_pack_${SLURM_JOB_ID}"
