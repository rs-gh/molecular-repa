#!/bin/bash
#!
#! SLURM job script for Proteina with REPA (60M, GearNet alignment)
...
#! Set data path (adjust to your setup — must contain metric_factory/model_weights/gearnet_ca.pth)
...
echo "Config: training_ca_repa"
echo "Time: $(date)"

CMD="python train_repa.py --config_name training_ca_repa --show_prog_bar"
