#!/bin/bash
#!
#! Run encoder_profiling/proteina/gearnet/explore_gearnet.py on a GPU node.
...
#!
#! Usage:
#!   sbatch hpc-scripts/proteina/encoder_profiling/explore_gearnet.sh                        # default: 200 proteins
#!   sbatch hpc-scripts/proteina/encoder_profiling/explore_gearnet.sh --n-proteins 500 --random-seed 0
#!
